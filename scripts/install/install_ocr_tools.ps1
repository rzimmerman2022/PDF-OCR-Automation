...
Write-Host "    .\\Universal-PDF-OCR-Processor.ps1 -InputPath `".\Documents`" -Language eng -Optimize 3 -DPI 300" -ForegroundColor Gray
Write-Host ""
Write-Host "  Python script:" -ForegroundColor Cyan
Write-Host "    python .\\ocr_pdfs.py `".\Documents`"" -ForegroundColor Gray
